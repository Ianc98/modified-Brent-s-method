...
disp('Note 1: a NaN in the modified_brent_root column means your method did not converge, i.e. info.flag = 1')
disp('Note 2: It is perfectly OK if you get a zero in the interval that is not the fzero one when [a, b] has multiple zeros')
